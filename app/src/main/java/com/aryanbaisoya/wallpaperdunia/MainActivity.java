...
public class MainActivity extends AppCompatActivity {
    ...
    Adapter adapter;
    CardView mnature,mbus,mcar,mtrain,mtrending,mmarvel;
    EditText editText;
    ImageButton search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mmarvel=findViewById(R.id.marvel);
        ...
        mmarvel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String query="marvel";
                getsearchimage(query);
    ...
    private void getsearchimage(String query) {
        ...
        ApiUyilities.getApiInterface().getSearchImage(query,1,80).enqueue(new Callback<SearchModel>() {
            @Override
    ...
    private void findphotos() {
        ...
        ApiUyilities.getApiInterface().getImage(1,80).enqueue(new Callback<SearchModel>() {
            @Override
            public void onResponse(Call<SearchModel> call, Response<SearchModel> response) {
                if(response.isSuccessful())
                {
